...
#if !WITH_SHADERS
#define MAX_SI_VS_BLIT_SGPRS 0
#define SI_NUM_VERTEX_BUFFERS 0
#define SI_NUM_GRAPHICS_SHADERS  0
#define SI_NUM_SHADERS 0
#define SI_NUM_SAMPLERS 0
#define SI_NUM_IMAGES 0
#define SI_NUM_DESCS 0
#define SI_MAX_ATTRIBS 0
